...
<aside class="filter-panel">
  ...
  <div class="filter-random">
    <button type="button" class="button button-primary button-full" disabled={filtered === 0} onclick={onRandomSong}>
      <Icon name="shuffle" size={18} />
      随机歌曲
    </button>
    <a href="#request-form" class="button button-secondary button-full">
